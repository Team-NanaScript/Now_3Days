...
class CListFragment : Fragment() {
    ...
    private val cList1 = ArrayList<ChallengeVO>()
    private val cList2 = ArrayList<ChallengeVO>()
...
//        }
        ...
        cList2.apply {
            add(ChallengeVO("은결이한테 질척거리기", "2021-11-06~2021-11-09"))
            add(ChallengeVO("영진이 놀리기", "2021-11-06~2021-11-30"))
            add(ChallengeVO("은빈언니한테 물어보기", "2021-11-06~2021-11-09"))
            add(ChallengeVO("영진이 놀리기", "2021-11-06~2021-11-30"))
            add(ChallengeVO("소연이랑 짜허하기", "2021-11-06~2021-11-09"))
            add(ChallengeVO("영진이 놀리기", "2021-11-06~2021-11-30"))
            add(ChallengeVO("소연이랑 짜허하기", "2021-11-06~2021-11-09"))
            add(ChallengeVO("영진이 놀리기", "2021-11-06~2021-11-30"))
        }
